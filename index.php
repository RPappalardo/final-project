    ...
    <form class="col s12">
      ...
      <div class="row">
        <div class="input-field col s12">
			 ...
			 <id="download-button" class="btn-large waves-effect waves-light orange">Login</a></h5>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col l3 s12">
          ...
          <ul>
            <li><a class="white-text" href="#!">Subtitles</a></li>
            <li><a class="white-text" href="#!">Audio</a></li>
            <li><a class="white-text" href="#!">Gameplay</a></li>
          </ul>
        </div>
        <div class="col l3 s12">
